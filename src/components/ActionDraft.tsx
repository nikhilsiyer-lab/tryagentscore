...
const CARD_META: Record<DraftType, {
  ...
  llms: {
    icon: '📄',
    title: 'llms.txt file',
    benefit: 'The most direct way to get cited — tells AI tools exactly what your business does.',
    effort: '10 min · No developer needed',
  ...
  schema: {
    ...
    benefit: 'Gives AI tools structured facts about your business type, location, and services.',
    effort: '20 min · Paste into your site <head>',
    generateLabel: 'Generate schema',
  },
  robots: {
    icon: '🤖',
    title: 'AI crawler access (robots.txt)',
    benefit: 'Confirms AI bots like GPTBot and ClaudeBot can read your site.',
    effort: '5 min · Add 4 lines to robots.txt',
    generateLabel: 'Show fix snippet',
  },
  meta: {
    icon: '✏️',
    title: 'Page title & description',
    benefit: 'Location-specific titles help AI tools understand and cite your page.',
    effort: '15 min · Edit in your CMS or theme',
    generateLabel: 'Generate suggestions',
  },
  faq: {
    icon: '💬',
    title: 'FAQ content & schema',
    benefit: 'Q&A format is one of the most cited content types in AI search.',
    effort: '30 min · Add to homepage or a new page',
